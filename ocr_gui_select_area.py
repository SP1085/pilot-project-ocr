...
def perform_ocr():
    ...
    if x2 <= x1 or y2 <= y1:
        messagebox.showwarning("เลือกตำแหน่งไม่ถูกต้อง", "กรุณาลากเมาส์เลือกบริเวณป้ายทะเบียนใหม่อีกครั้ง")
        return
...
# ==== GUI ====
window = tk.Tk()
window.title("OCR อ่านตัวหนังสือ - ลากเมาส์เลือกตำแหน่ง")
